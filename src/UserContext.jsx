...
async function login(username, password) {
    ...
    setError(null);
    try {
      const res = await fetch('https://sanjar1718.pythonanywhere.com/api/login/', {
        method: 'POST',
  ...
  async function register(formData) {
    ...
    setError(null);
    try {
  const res = await fetch('https://sanjar1718.pythonanywhere.com/api/register/', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
async function fetchProfile() {
  ...
  if (token === "49433f8669f1c84cbccb417fbb7f74e1284245e2") {
    setUser({
      id: 1,
      username: "admin",
  ...
  async function fetchProfile(currentToken = token) {
    ...
    setError(null);
    try {
  const res = await fetch('https://sanjar1718.pythonanywhere.com/api/auth/profile/', {
  ...
  return (
  <UserContext.Provider value={{ user, token, loading, error, login, logout, register, fetchProfile }}>
      {children}
...
//         profile_type: "teacher",
//       };
//       const demoToken = "49433f8669f1c84cbccb417fbb7f74e1284245e2";
