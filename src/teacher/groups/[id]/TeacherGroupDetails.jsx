    ...
    return (
      <div className={`flex h-screen ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
        ...
        <div className="flex-1 ml-64 flex flex-col">
          ...
          <div className="flex-1 p-8 flex items-center justify-center">
            <div className="text-center">
              <p className={isDarkMode ? 'text-red-400' : 'text-red-600'}>Failed to load group details.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex-1 p-8 flex flex-col">
                  ...
                  <div className={`grid grid-cols-2 gap-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} text-sm`}>
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center">
                        ...
                        <span className="font-medium">Students:</span> <span className="ml-1">{group.students ? group.students.length : 0} enrolled</span>
                      </div>
                      <div className="flex items-center">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className={`flex items-center ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'} rounded-lg p-1`}>
              ...
              >
                <i className="ri-calendar-check-line w-4 h-4 items-center justify-center mr-2 inline-flex"></i>
              ...
              >
                <i className="ri-file-text-line w-4 h-4 items-center justify-center mr-2 inline-flex"></i>
