// src/lessonApi.js // API helper for lessons
const BASE_URL = 'https://sanjar1718.pythonanywhere.com';
// const token = "7603f2857ddbd7f36869ddd632924c00da967f61"

export async function getLessons(token) {
  return fetch(`${BASE_URL}/api/lessons/`, {
    headers: { 'Authorization': `Token ${token}` }
  }).then(res => res.json());
}

export async function getLesson(id, token) {
  return fetch(`${BASE_URL}/api/lessons/${id}/`, {
    headers: { 'Authorization': `Token ${token}` }
  }).then(res => res.json());
}

export async function getLessonHomework(id, token) {
  return fetch(`${BASE_URL}/api/lessons/${id}/homework/`, {
    headers: { 'Authorization': `Token ${token}` }
  }).then(res => res.json());
}

export async function getLessonHomeworkTasks(id, token) {
  return fetch(`${BASE_URL}/api/lessons/${id}/homework/tasks/`, {
    headers: { 'Authorization': `Token ${token}` }
  }).then(res => res.json());
}
...
export async function assignTeacher(id, data, token) {
  return fetch(`${BASE_URL}/api/lessons/${id}/assign_teacher/`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Token ${token}`
...
export async function removeTeacher(id, data, token) {
  return fetch(`${BASE_URL}/api/lessons/${id}/remove_teacher/`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Authorization': `Token ${token}`
...
export async function getMyLessons(token) {
  return fetch(`${BASE_URL}/api/lessons/my_lessons/`, {
    headers: { 'Authorization': `Token ${token}` }
  }).then(res => res.json());
}
...
export async function searchLessons(params, token) {
  ...
  return fetch(`${BASE_URL}/api/lessons/search/?${query}`, {
    headers: { 'Authorization': `Token ${token}` }
  }).then(res => res.json());
}
